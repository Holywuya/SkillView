...
object SkillCaster {
    ...
    private fun executeInternalCast(player: Player, slotIndexStr: String) {
        ...
        val finalDamage = ((playerAttr * realBaseMultiplierPercent * realDmgBonusMultiplier)*realSkillPower) * realDmgMoreMultiplier
